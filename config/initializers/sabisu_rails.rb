...
SabisuRails.setup do |config|
  ...
  config.base_api_uri = 'api.deadlinesapi.dev:88'
  ...
  # You can configure the api headers fairly easy by just adding the correct headers
   config.api_headers = { "Accept" => "application/vnd.deadlines.v1" }
  #
  # config.api_headers = {}
  ...
  # Resources on the api
   config.resources = [:users, :deadlines]
